...
=============================================================================
   * Gestione versamenti iscritti - inserimento e ricerc
   19/01/2023	a)-default 30€
============================================================================= */
...
$btx    = new bottoni_str_par('Nuovo versamento','ver','write_ver.php',$param);  
     $btx->btn();
...
// lato destro                                                           
     ...
     $f4 = new input(array(date("d-m-Y"),'vdata',11,'Data','Data del versamento','d1'));              
          $f4->field();
     $n  = number_format(30,2,',','');    // a)-edit decimale valore di default
