...
include'fields_nav.php';
       ...
       if ( ($accesso >= $naccesso) )   
          ...
          if (($ntipo == 'arg') || ($ntipo == 'cap') || ($ntipo == 'art') || ($ntipo == 'htm'))
            {
            echo "<a class='current' href='index.php?content=".$ntipo."&dati=".$nsotvo."&pag=".$npag."'>".$nli."</a>";
            }
          else
            {
            echo "<a class='current' href='index.php?content=".$ntipo."&urla=".$nsotvo."&pag=".$npag."'>".$nli."</a>";            
            }
