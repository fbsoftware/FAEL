...
foreach($PDO->query($sql2) as $row2)  
     ...
     if ($accesso >= $xnaccesso)  
          ...
          if (($xtipo == 'arg') || ($xtipo == 'cap') || ($xtipo == 'art') || ($xtipo == 'htm'))
            {
            echo "<li><a class='current' href='index.php?content=".$xtipo."&dati=".$xsotvo."&pag=".$xpag."'>".$xli."</a></li>";
            }
            else
            {                                                                                                          
            echo "<li><a class='current' href='index.php?content=".$xtipo."&urla=".$xsotvo."&pag=".$xpag."'>".$xli."</a></li>";            
            }
          }
     }
        echo "</ul>";  
