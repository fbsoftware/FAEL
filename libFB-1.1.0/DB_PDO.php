...
==================================================================================
	...
	si leggeranno i 2 files dei versamenti e si sceglierà il maggiore dei 2.
	funzione: insert2()
============================================================================= */
...
// n° record inserimento da config.ini ===========================================
...
// n° record inserimento +1 (maggiore dei 2) ========================================
       public function insert2()          
        { 
			...
			// scelta del maggiore
                if ($this->maxver > $this->maxvel )
					{
					return $this->max = $this->maxver;                  
					}
				else
					{
					return $this->max = $this->maxvel;  
					}
		}
