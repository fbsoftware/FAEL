 ...
 * 23/08/2023	aggiunto campo email
 * ============================================================================= */
// DOCTYPE & head
...
// inserimento 
    case 'nuovo':
    {
     ...
     $a1 = new input(array(' ','note',33,'Note',' ','i'));
          $a1->field();
     $a1 = new input(array(' ','email',80,'Email',' ','i'));
          $a1->field();
     echo "</fieldset>"; 
     echo "</div>";  // col 
     echo "</div>";  // row                                                             
...
foreach($PDO->query($sql) as $row)
     ...
     $x1 = new input(array($note,'note',33,'Note',' ','i'));
          $x1->field();
     $a1 = new input(array($email,'email',80,'Email',' ','i'));
          $a1->field();
     }
     echo  "</fieldset>";                                                                 
     echo "</div>";    // col
...
foreach($PDO->query($sql) as $row)
     ...
     $a1 = new input(array(1,'tipo',1,'Tipo','','r'));
          $a1->field();
     $a1 = new input(array($note,'note',33,'Note',' ','r'));
          $a1->field();
     $a1 = new input(array($email,'email',80,'Email',' ','r'));
          $a1->field();
     }
     echo "</fieldset>";                                                                 
     echo "</div>";    // col
