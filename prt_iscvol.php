...
=============================================================================  
   * Stampa standard - ISCRITTI VOLONTARI
=============================================================================  */
...
{   global $title;
    ...
    $this->Cell(280,9,$title,1,1,'C',1);           //Title
...
$title=DB::$page_title." - ISCRITTI - Elenco volontari al ".$adata."";
$pdf->AddPage();   
$pdf->SetTitle($title);
