...
echo  "<button class='fb-secondary fb-p05 fb-rad7 fb-m05' type='submit' name='submit' value='Login' ><img src='https://fbsoftware.github.io/FB-CODE/images/utente.png' alt='utente' height='25' />&nbsp;&nbsp;&nbsp;&nbsp;Accedi</button>";
echo  "<button class='fb-accent fb-p05 fb-rad7 fb-m05' type='reset' name='submit_back' value='Resetta' ><img src='https://fbsoftware.github.io/FB-CODE/images/annulla.png' alt='annulla' height='25' />&nbsp;&nbsp;&nbsp;&nbsp;Resetta</button>";
echo  "</div>";
echo  "</form>";
// se errori ...
echo "<div>";
